      ...
      setTimeout(() => {
        ...
        if (container) {
          ...
          if (activeStep) {
            ...
            var scrollPosition =
              (stepWidth + stepMargin + $('.line').width()) * index
  ...
  document
    ...
    .addEventListener('click', async function () {
      ...
      const organizedData = {
        ...
        contractStartDate:
          allFormData['sozlesme-form']?.contractStartDate || '',
        contractEndDate: allFormData['sozlesme-form']?.contractEndDate || '',
        startingRentAmount:
          allFormData['sozlesme-form']?.startingRentAmount || '',
        ...
        maintenanceStartDate:
          allFormData['aidat-form']?.maintenanceStartDate || '',
        maintenanceFeeAmount:
          allFormData['aidat-form']?.maintenanceFeeAmount || '',

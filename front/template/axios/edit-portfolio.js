...
document.addEventListener('DOMContentLoaded', async function () {
  ...
  async function getPortfolio() {
    try {
      const response = await axios.post(
        'http://localhost:3001/api/v1/emlakze/admin/getportfolioo',
        {},
        {
    ...
    try {
      ...
      if (titleDeeds) {
        ...
        setInputValue(
          ...
          titleDeeds.independentSectionDescription || '',
        )
        ...
        setInputValue(
          ...
          titleDeeds.titleDeedTransferMethod || '',
        )
        setInputValue(
          '#titleDeedTransferDate',
          titleDeeds.titleDeedTransferDate || '',
        )
        setInputValue('#ownership', titleDeeds.ownership || '')
        setInputValue(
          '#mainPropertyDescription',
          titleDeeds.mainPropertyDescription || '',
        )
  ...
  async function updateProperty() {
    const propertyData = {
      ...
      titledeed: {
        titledeedprovince:
          document.querySelector('#titledeedprovince').value || '',
        location: document.querySelector('#location').value || '',
        area: document.querySelector('#area').value || '',
        parcelShare: document.querySelector('#parcelShare').value || '',
        parcelShareholder:
          document.querySelector('#parcelShareholder').value || '',
        description: document.querySelector('#description').value || '',
        independentSectionDescription:
          document.querySelector('#independentSectionDescription').value || '',
        ...
        titleDeedTransferMethod:
          document.querySelector('#titleDeedTransferMethod').value || '',
        titleDeedTransferDate:
          document.querySelector('#titleDeedTransferDate').value || '',
        ownership: document.querySelector('#ownership').value || '',
        mainPropertyDescription:
          document.querySelector('#mainPropertyDescription').value || '',
        bbShareRatio: document.querySelector('#bbShareRatio').value || '',
        restrictionStatus:
          document.querySelector('#restrictionStatus').value || '',
    ...
    try {
      const response = await axios.post(
        'http://localhost:3001/api/v1/emlakze/admin/updateportfolio',
        propertyData,
        {
          headers: { 'Content-Type': 'application/json' },
        },

...
const setPropertyInput = z.object({
  ...
  details: z.object({
    ...
    attribute: z.enum(['','konut', 'isyeri', 'ofis', 'dukkan', 'arsa']).optional(),
    type: z.enum(['','1+0', '1+1', '2+1', '3+1', '4+1', '3+1Dblx', '2+1Dblx', '1+1Loft', '2+1Loft', 'StudyoLoft']).optional(),
    ...
    zoningStatus: z.enum(['',
      ...
      'ParselasyonPlani', 'IlaveImarPlani', 'KorumaAmacliImarPlanı', 'MevziImarPlanı'
    ]).optional(),
...
module.exports = {
  ...
  getLocationInput, updateStatusCustomerInput, updateStatusPropertyInput, adminLoginInput,
  setRentInput,
  getRentInput,
  setExpenseInput,
  getExpenseInput,
  ...
  getRentByIdInput,
  getExpenseByIdInput,
  setPhotoInput, photoSchema, testPhotoInput, updateExpenseInput, testFileInput, getFileInput,
  getTitleDeedInput,
  deletePhotoInput,
  setPortfolioInput,
  getPortfolioInput,
